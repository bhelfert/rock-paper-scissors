...
Test report
-----------
A nice HTML report for the tests that were run can be generated by using:
```
./gradlew [clean] test
```
...
If you choose the filter "Classes" ("Packages" is the default) and select a class, you quickly can get a good overview on
